...
<script type="text/javascript">
    ...
    var seriesData = [];
    $.ajax({
        url:'${pageContext.request.contextPath}/userpay/vipsvip',
        dataType:'json',
        async: false,
        processType:true,
    ...
    $(function () {
        ...
        $('#selectBtn').on('click',function () {
            ...
            $.ajax({
                url:'${pageContext.request.contextPath}/userpay/vipsvip?startDate='+startDate+
    ...
    /*function initTable() {
        $("#table1").bootstrapTable({
            url: '/userpay/payfailuser', // 获取表格数据的url
            cache: false,
            striped: true,
            showRefresh:true,
            showColumns:true,
