...
<script type="text/javascript">
    ...
    var seriesData = [];
    $.ajax({
        url:'${pageContext.request.contextPath}/rl/rlrate',
        dataType:'json',
        async: false,
        processType:true,
            ...
            if (startDate != "" && endDate != "") {
                ...
                if (provinceName == "") {
                    ...
                    if (cityName == ""){
                        //查询 省
                        $.ajax({
                            url:'${pageContext.request.contextPath}/rl/rlrate?provinceName='+provinceName,
                            success: function(data) {
                                console.log(data)
                                option.series[0].data = data;
                        ...
                        // 查询 市
                        $.ajax({
                            url:'${pageContext.request.contextPath}/rl/rlrate?cityName='+cityName,
                            success: function(data) {
                                console.log(data)
                                option.series[0].data = data;
